...
Usage:
    python -m app.cli.seed_admin --email admin@example.com --password 'S3cret!'
    python -m app.cli.seed_admin --email admin@example.com   # prompts (or $ADMIN_PASSWORD)
    python -m app.cli.seed_admin --email admin@example.com --promote-only
...
Run inside the backend container:
    docker compose exec backend python -m app.cli.seed_admin --email ...
"""
