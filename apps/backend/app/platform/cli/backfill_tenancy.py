...
Usage:
    python -m app.platform.cli.backfill_tenancy [--dry-run] [--batch-size 5000]
    python -m app.platform.cli.backfill_tenancy --users-only      # phase A only
    python -m app.platform.cli.backfill_tenancy --resources-only  # phase B only
