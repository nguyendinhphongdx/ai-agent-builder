...
- ``account.updated`` → mirror Connect onboarding flags onto User row
  (handler lives in ``app.modules.payouts.service`` since it's an author-side
...
from app.modules.payments.providers.stripe import handle_checkout_completed, is_stripe_configured
...
async def stripe_webhook(
    ...
    if event_type == "checkout.session.completed":
        ...
        from app.modules.payouts.service import sync_account_from_event
        ...
        from app.modules.billing.webhooks import handle_subscription_event
        ...
        from app.modules.billing.webhooks import handle_subscription_deleted
        ...
        from app.modules.billing.webhooks import handle_invoice_payment_failed
