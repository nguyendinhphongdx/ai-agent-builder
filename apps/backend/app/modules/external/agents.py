...
from app.modules.agents.executor import execute_agent_stream
from app.modules.agents.service import get_agent, list_agents
from app.modules.ai_credentials.service import get_plaintext_key_by_id
from app.modules.auth.dependencies import get_current_user, require_scope
...
from app.modules.external.schemas import AgentSummary, ChatRequest, ChatResponse
...
async def chat_stream(
    ...
    """
    from app.modules.conversations.sse import chat_sse  # local import to avoid cycle
