...
``app.background.kb_sync`` and runs from the FastAPI
...
from app.core.kb_connectors.sync import run_connector
...
from app.modules.studio.knowledge.service import get_knowledge_base
