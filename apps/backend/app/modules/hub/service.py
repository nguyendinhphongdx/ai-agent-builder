...
from app.modules.hub.schemas import TemplatePublishRequest
from app.modules.hub.snapshot import (
...
async def publish_agent(
    ...
    if body.price_cents > 0 and body.currency.upper() != "VND":
        from app.modules.payouts.service import can_receive_payouts
    ...
    if template.include_kb_content:
        from app.modules.hub.snapshot import freeze_kb_content_for_version
...
async def publish_new_version(
    ...
    *,
    ...
    from app.modules.hub.snapshot import build_snapshot_from_agent, load_agent_for_snapshot
