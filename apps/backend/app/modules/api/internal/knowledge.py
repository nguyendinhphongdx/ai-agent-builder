...
from app.modules.runtime.jobs import service as job_service
from app.modules.studio.knowledge.service import (
    get_document,
...
class IngestRequest(BaseModel):
    kb_id: uuid.UUID
    doc_id: uuid.UUID
    # Injected by app.modules.runtime.jobs.producer.enqueue — lets this handler walk
