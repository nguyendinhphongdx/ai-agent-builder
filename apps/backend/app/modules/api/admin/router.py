...
from app.modules.api.admin import service
from app.modules.api.admin.jobs import router as admin_jobs_router
from app.modules.api.admin.schemas import (
    AdminActionRow,
    AdminPurchaseRow,
    AdminStats,
    AdminTemplateRow,
...
from app.modules.identity.auth.permissions import UserRole, require_role
from app.modules.ops.audit.router import admin_router as admin_audit_router
