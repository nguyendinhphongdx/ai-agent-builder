...
from app.modules.studio.agents.orchestration.schemas import (
    MultiAgentResponse,
    PeerRequest,
    SupervisorRequest,
)
...
async def run_supervisor_endpoint(  # Chạy supervisor pattern: agent đầu điều phối, các agent sau là worker
    ...
    from app.modules.studio.agents.orchestration.supervisor import run_supervisor
...
async def run_peer_endpoint(  # Chạy peer collaboration: các agent xử lý tuần tự
    ...
    from app.modules.studio.agents.orchestration.peer import run_peer_collaboration
